...
async function fetchDashboardStatistics() {
    ...
    try {
        ...
        // FIXED: Using standard JavaScript .json() instead of Python's .get_json()
        const data = await response.json();
        console.log("Live Database Statistics Received:", data);
        ...
        const coursesContainer = document.getElementById("totalTestsCount");
